...
void failed_message(struct discord_embed *embed, struct discord_embed_params *params, char *reason, u64_snowflake_t channel_id) {
    embed->color = COLOR_RED;
    snprintf(embed->title, 257, "Failed!");
    snprintf(embed->description, 2049, "Reason: %s", sqlite3_errmsg(errMsg));
